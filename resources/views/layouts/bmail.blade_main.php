...
<head>
    ...
    <title>Email Application - Chameleon Admin - Modern Bootstrap 4 WebApp & Dashboard HTML Template + UI Kit</title>
...
<body class="vertical-layout vertical-menu content-left-sidebar email-application  menu-expanded fixed-navbar"
            ...
            <div class="collapse navbar-collapse show" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="dropdown nav-item mega-dropdown d-none d-md-block"><a class="dropdown-toggle nav-link"
                        ...
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                ...
                                <ul>
                                    <li><a class="my-1" href="index-2.html"><i class="ft-home mr-1"></i> Dashboard</a>
                                    </li>
                                    ...
                                    <li><a class="my-1" href="form-wizard.html"><i class="ft-edit mr-1"></i> Form Wizard</a>
                                    </li>
                                    <li><a class="my-1" href="table-bootstrap.html"><i class="ft-grid mr-1"></i> Tables</a>
                                    </li>
                    ...
                    <li class="dropdown d-none d-md-block mr-1"><a class="dropdown-toggle nav-link"
                                                                   id="apps-navbar-links" href="#"
                                                                   data-toggle="dropdown">
                            Apps</a>
                        <div class="dropdown-menu">
                            <div class="arrow_box"><a class="dropdown-item" href="email-application.html"><i
                                            class="ft-user"></i> Email</a><a class="dropdown-item" href="chat-application.html"><i
                                            class="ft-mail"></i> Chat</a><a class="dropdown-item" href="project-summary.html"><i
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                                    ...
                                    class="avatar avatar-online"><img
                                        src="{{asset("app-assets/images/portrait/small/avatar-s-19.png")}}" alt="avatar"></span></a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="arrow_box_right"><a class="dropdown-item" href="#"><span
                                            class="avatar avatar-online"><img
                                                src="{{asset("app-assets/images/portrait/small/avatar-s-19.png")}}" alt="avatar"><span
...
<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true"
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="index-2.html"><i class="ft-home"></i><span class="menu-title" data-i18n="">Dashboard</span><span
            ...
            <li class=" nav-item"><a href="#"><i class="ft-layers"></i><span class="menu-title" data-i18n="">Apps</span></a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="email-application.html">Email Application</a>
                    </li>
            ...
            <li class=" nav-item"><a href="#"><i class="ft-monitor"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#">Vertical</a>
                        <ul class="menu-content">
                            <li><a class="menu-item"
                                   href="https://themeselection.com/demo/chameleon-admin-template/html/rtl/vertical-menu-template">Classic
                                    Menu</a>
                            </li>
                            <li><a class="menu-item"
                                   href="https://themeselection.com/demo/chameleon-admin-template/html/rtl/vertical-modern-menu-template">Modern
                                    Menu</a>
                            </li>
                        </ul>
                    </li>
                    <li><a class="menu-item" href="#">Horizontal</a>
                        <ul class="menu-content">
                            <li><a class="menu-item"
                                   href="https://themeselection.com/demo/chameleon-admin-template/html/rtl/horizontal-menu-template-nav">Full
                                    Width</a>
                            </li>
                        </ul>
                    </li>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#">Content Sidebar</a>
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="layout-content-detached-left-sticky-sidebar.html">Sticky left
                                    sidebar</a>
                            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="ft-zap"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#">Content sidebar</a>
                        <ul class="menu-content">
                            <li><a class="menu-item"
                                   href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-content-detached-left-sidebar.html">Left
                                    sidebar</a>
                            </li>
                            <li><a class="menu-item"
                                   href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-content-detached-left-sticky-sidebar.html">Sticky
                                    left sidebar</a>
                            </li>
                            <li><a class="menu-item"
                                   href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-content-detached-right-sidebar.html">Right
                                    sidebar</a>
                            </li>
                            <li><a class="menu-item"
                                   href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-content-detached-right-sticky-sidebar.html">Sticky
                                    right sidebar</a>
                            </li>
                        </ul>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item"
                           href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-fixed-navbar.html">Fixed
                            navbar</a>
                    </li>
                    <li><a class="menu-item"
                           href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-fixed-navigation.html">Fixed
                            navigation</a>
                    </li>
                    <li><a class="menu-item"
                           href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-fixed-navbar-navigation.html">Fixed
                            navbar &amp; navigation</a>
                    </li>
                    <li><a class="menu-item"
                           href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-fixed-navbar-footer.html">Fixed
                            navbar &amp; footer</a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item"
                           href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-fixed.html">Fixed
                            layout</a>
                    </li>
                    <li><a class="menu-item"
                           href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-boxed.html">Boxed
                            layout</a>
                    </li>
                    <li><a class="menu-item"
                           href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-static.html">Static
                            layout</a>
                    </li>
                    <li class="navigation-divider"></li>
                    <li><a class="menu-item"
                           href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-light.html">Navigation
                            Light</a>
                    </li>
                    <li><a class="menu-item"
                           href="https://themeselection.com/demo/chameleon-admin-template/starter-kit/rtl/vertical-menu-template/layout-dark.html">Navigation
                            Dark</a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item"><a href="changelog.html"><i class="ft-file"></i><span class="menu-title" data-i18n="">Changelog</span><span
            ...
            <div class="sidebar-content email-app-sidebar d-flex">
                <div class="email-app-menu col-md-5 card d-none d-lg-block rounded-0">
                    ...
                    <div class="list-group list-group-messages">
                        <a href="#" class="list-group-item list-group-item-action border-0 active">Inbox
                            <span class="primary float-right">8</span>
                        </a>
                        <a href="#" class="list-group-item list-group-item-action border-0">Sent</a>
                        <a href="#" class="list-group-item list-group-item-action border-0">Draft</a>
                        <a href="#" class="list-group-item list-group-item-action border-0">Junk </a>
                        <a href="#" class="list-group-item list-group-item-action border-0">Trash</a>
                        <a href="#" class="list-group-item list-group-item-action border-0">Starred </a>
                        <a href="#" class="list-group-item list-group-item-action border-0">Reminder
                            <span class="primary float-right">1</span>
                        </a>

                    </div>
                    <h6 class="text-muted text-bold-500 mt-1 mb-1 ml-1">Labels</h6>
                    <div class="list-group list-group-messages">
                        <a href="#" class="list-group-item list-group-item-action border-0">
                            <i class="ft-circle mr-1 warning"></i> Personal
                        </a>
                        <a href="#" class="list-group-item list-group-item-action border-0">
                ...
                <div class="email-app-list-wraper col-md-7 card p-0 rounded-0">
                    <div class="email-app-list">
                        <div class="card-body chat-fixed-search text-center">

                            <fieldset class="form-group position-relative has-icon-left m-0 pb-1">
                                <div class="btn-group ml-1">
                                    <button type="button"
                                            class="btn btn-sm btn-icon btn-pure dropdown-toggle font-medium-2"
                                            data-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">
                        ...
                        <div id="users-list" class="list-group">
                            <div class="users-list-padding media-list">
                                <a href="#"
                                   class="media border-right-primary border-right-2 pb-0 border-bottom-blue-grey border-bottom-lighten-5">
                                    <div class="media-left text-center">
                                        <p>
                                        <span class="avatar avatar-md">
                                            <img class="media-object rounded-circle box-shadow-2"
                                                 src="{{asset("app-assets/images/portrait/small/avatar-s-6.png")}}"
                                    ...
                                    <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Sarah Montery
                                        <span class="float-right">
                                            <span class="font-small-2 text-muted blue-grey ">Today</span>
                                        </span>
                                    </span>
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block"> Project Customization</span>
                                        <p class="list-group-item-text text-muted mb-1">Everything looks good. I will
                                            provide you some more details within couple of days...
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                </a>
                                <a href="#" class="media border-0 pb-0 border-bottom-blue-grey border-bottom-lighten-5">
                                    <div class="media-left text-center">
                                        <p>
                                <span class="avatar avatar-md">
                                    ...
                                    <div class="media-body w-100">
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Elizabeth Elliott
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">8 July</span>
                                </span>
                            </span>
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block"> Okay, I will call you.</span>
                                        <p class="list-group-item-text text-muted mb-1">Here is some more details on how
                                            you will do that. Please check and let me know...
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                </a>
                                ...
                                <span class="avatar avatar-md">
                                    <span class="media-object rounded-circle text-circle bg-success ">H</span>
                                        ...
                                        <p>
                                            <i class="ft-circle warning"></i>
                                        </p>
                                    </div>
                                    <div class="media-body w-100">
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Heather Howell
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">15 July</span>
                                </span>
                            </span>
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block"> Thanks, Let's do it.</span>
                                        <p class="list-group-item-text text-muted mb-1">Can we connect today and discuss
                                            few things...
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                ...
                                <span class="avatar avatar-md">
                                    <img class="media-object rounded-circle "
                                         src="{{asset("app-assets/images/portrait/small/avatar-s-10.png")}}"
                                         alt="Generic placeholder image">
                                </span>
                                        </p>
                                        <p>
                                    ...
                                    <div class="media-body w-100">
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Kelly Reyes
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">12 July</span>
                                </span>
                            </span>
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block"> I paid it, Thanks.</span>
                                        <p class="list-group-item-text text-muted mb-1">Check once and let me know if
                                ...
                                <span class="avatar avatar-md">
                                    ...
                                    <div class="media-body w-100">
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Vincent Nelson
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">11 July</span>
                                </span>
                            </span>
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block"> Where are you John?</span>
                                        <p class="list-group-item-text text-muted mb-1">Hey Let's go party tonight, i am
                                            really excited..
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                ...
                                <span class="avatar avatar-md">
                                    ...
                                    <div class="media-body w-100">
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Tonny Deep
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">4:14 AM</span>
                                </span>
                            </span>
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block">ThemeSelection, I found you on...</span>
                                        <p class="list-group-item-text text-muted mb-1">We will start the new project
                                            development soon and complete it within this year...
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                </a>
                                ...
                                <span class="avatar avatar-md">
                                    ...
                                    <div class="media-body w-100">
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Louis Welch
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">2:15 AM</span>
                                </span>
                            </span>
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block">Thank you, Let's do few....</span>
                                        <p class="list-group-item-text text-muted mb-1">Can we connect today and discuss
                                            few things regarding this project...
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                </a>
                                ...
                                <span class="avatar avatar-md">
                                    ...
                                    <div class="media-body w-100">
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Envato Market
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">11:18 PM</span>
                                </span>
                            </span>
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block">You have a new comment...</span>
                                        <p class="list-group-item-text text-muted mb-1">Hi ThemeSelection, this is to
                                            inform...
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                ...
                                <span class="avatar avatar-md">
                                    ...
                                    <div class="media-body w-100">
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Wayne Burton
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">Today</span>
                                </span>
                            </span>
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block">Project ABC Status...</span>
                                        <p class="list-group-item-text text-muted mb-1">Andy, Here's a new layout for a
                                            new Chameleon Admin theme
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                </a>
                                ...
                                <span class="avatar avatar-md">
                                    ...
                                    <div class="media-body w-100">
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Sarah Montgo
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">Yesterday</span>
                                </span>
                            </span>
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block">Your New UI...</span>
                                        <p class="list-group-item-text text-muted mb-1">Everything looks good.Hope that
                            ...
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Heather Howell
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">15 July</span>
                                        ...
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block">Thanks, Let's do it...</span>
                                        <p class="list-group-item-text text-muted mb-1">Can we connect today...
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                </a>
                            ...
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Kelly Reyes
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">12 July</span>
                                        ...
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block"> paid it, Thanks.</span>
                                        <p class="list-group-item-text text-muted mb-1">Check once and provide your
                                            valuable feedback...
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                            ...
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Kelly Reyes
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">12 July</span>
                                        ...
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block"> paid it, Thanks.</span>
                                        <p class="list-group-item-text text-muted mb-1">Check once...
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                </a>
                                <a href="#" class="media border-0 pb-0">
                                    <div class="media-left text-center">
                                        <p>
                                <span class="avatar avatar-md">
                                    <span class="media-object rounded-circle text-circle bg-warning ">V</span>
                            ...
                            <span class="list-group-item-heading text-bold-700 font-medium-2 line-height-1">Vincent Nelson
                                <span class="float-right">
                                    <span class="font-small-2 text-muted blue-grey ">11 July</span>
                                        ...
                                        <span class="list-group-item-text text-truncate text-bold-600 mb-0 line-height-2 display-block"> Where are you John?</span>
                                        <p class="list-group-item-text text-muted mb-1">Party tonight ?
                                            <span class="float-right primary"></span>
                                        </p>
                                    </div>
                                </a>
                            ...
                            <div class="row">
                                <div class="col-xl-5 d-lg-none d-xl-block">
                                    <button type="button" class="btn btn-sm btn-icon btn-pure">
                                        <i class="ft-trash-2 font-medium-5"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-icon btn-pure">
                                        <i class="la la-reply font-medium-5"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-icon btn-pure">
                                        <i class="la la-reply-all font-medium-5"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-icon btn-pure">
                                        <i class="la la-mail-forward font-medium-5"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-icon btn-pure">
                                        <i class="ft-more-horizontal font-medium-5"></i>
                                    </button>
                                </div>
                                <div class="col-xl-4 col-lg-12 text-center ">
                                    <fieldset class="form-group position-relative has-icon-left m-0 pb-1">
                                        <input type="text" class="form-control round" id="iconLeft4"
                        ...
                        <div class="email-app-title card-body">
                            <div class="row">
                                <div class="col-md-8 col-12 text-left ">
                                    <h3 class="list-group-item-heading">Project Customization</h3>
                                </div>
                                <div class="col-md-4 col-12 text-right">
                                    <i class="font-medium-1 ft-star blue-grey lighten-3 font-medium-5"></i>
                                    <i class="ft-paperclip font-medium-5 pl-1"></i>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-3 col-lg-12 mb-1">
                                                    <img class="img-thumbnail img-fluid"
                                                         src="{{asset("app-assets/images/gallery/16.jpg")}}"
                                                         alt="Image description">
                                                </div>
                                                <div class="col-xl-3  col-lg-12  mb-1">
                                                    <img class="img-thumbnail img-fluid"
                                                         src="{{asset("app-assets/images/gallery/5.jpg")}}"
                                                         alt="Image description">
                                                </div>
                                                <div class="col-xl-3  col-lg-12  mb-1">
                                                    <img class="img-thumbnail img-fluid"
                                                         src="{{asset("app-assets/images/gallery/4.jpg")}}"
                                                         alt="Image description">
                                                </div>
...
<div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-xl-block"><a class="customizer-close"
    ...
    <div class="customizer-content p-2">
        ...
        <div class="cz-bg-image row">
            <div class="col mb-3">
                <img src="{{asset("app-assets/images/backgrounds/04.jpg")}}" class="rounded sidiebar-bg-img" width="50"
                     height="100" alt="background image">
            </div>
            <div class="col mb-3">
                <img src="{{asset("app-assets/images/backgrounds/01.jpg")}}" class="rounded sidiebar-bg-img")}}" width="50"
                     height="100" alt="background image">
            </div>
            <div class="col mb-3">
                <img src="{{asset("app-assets/images/backgrounds/02.jpg")}}" class="rounded sidiebar-bg-img")}}" width="50"
                     height="100" alt="background image">
            </div>
            <div class="col mb-3">
                <img src="{{asset("app-assets/images/backgrounds/05.jpg")}}" class="rounded sidiebar-bg-img")}}" width="50"
                     height="100" alt="background image">
            </div>
        </div>
