...
<!-- Mirrored from themeselection.com/demo/chameleon-admin-template/html/rtl/vertical-menu-template/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Mar 2019 16:01:52 GMT -->
<head>
        ...
        <div class="content-body">
            <section class="flexbox-container">
                <div class="col-12 d-flex">
                    <div class="col-md-4 col-10 box-shadow-2 p-0 offset-1">
                        <div class="card border-grey border-lighten-3  m-0">
                            <div class="card-header border-0 header_loging">
                                <div class="text-center mb-1">
                                    <img src="{{asset('app-assets/images/logo/logo.png')}}" alt="{{trans("mb.brand")}}">
                                </div>
                                <div class="font-large-1  text-center white">
                                    {{trans("mb.ticketLoginHeader")}}
                                </div>
                            </div>
                            <div class="card-content content_login">
                                @yield('content')
...
<!-- Mirrored from themeselection.com/demo/chameleon-admin-template/html/rtl/vertical-menu-template/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Mar 2019 16:01:53 GMT -->
</html>