                                        ...
                                        <ul class="list-inline mb-0">
                                            <li>
                                                <a class="btn btn-sm btn-white danger box-shadow-1 round btn-min-width pull-right"
                                                   href="#" target="_blank"><?php echo e(trans("mb.compose")); ?><i class="ft-mail pl-1"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="media d-flex">
                                            <div class="media-body text-left mt-1">
                                                ...
                                                <h6 class="mt-1"><span class="text-muted white"><?php echo e(__("mb.tickets").' '.__("mb.in")); ?> <a
                                                                href="#" class="darken-2 white"><?php echo e(__("mb.lastWeek")); ?>....</a></span>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
